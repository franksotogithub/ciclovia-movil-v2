...
export class TramoModel implements  TramoRequets {
 ...
 seguridad_2_por : number;
  ...
  constructor(t?: TramoRequets){
   ...
   this.senial_v_2_tipo           =t?t.senial_v_2_tipo:'P-46'          ;   
   ...
   this.senial_v_3_tipo           =t?t.senial_v_3_tipo :   'P-46A'     ; 
   ...
   this.senial_v_4_tipo           =t?t.senial_v_4_tipo :   'P-46B' ;     
   ...
   this.senial_h_1_tipo           =t?t.senial_h_1_tipo:'INTERIOR CICLOVIA'          ;
   ...
   this.senial_h_2_tipo           =t?t.senial_h_2_tipo:'CRUCES'          ;     
   ...
   this.estado_1_tipo =t?t.estado_1_tipo:'AGRIETAMIENTO'  ;     
   this.estado_1_por =t?.estado_1_por;     
   this.estado_1_obs =t?.estado_1_obs;     
  
  
    
   this.estado_2_tipo =t?t.estado_2_tipo:'HUNDIMIENTO'  ;     
   this.estado_2_por =t?.estado_2_por;     
   this.estado_2_obs =t?.estado_2_obs;     
  
  
   this.estado_3_tipo =t?t.estado_3_tipo:'RAICES DE ARBOL'  ;     
   this.estado_3_por =t?.estado_3_por;     
   this.estado_3_obs =t?.estado_3_obs;     


   this.estado_4_tipo =t?t.estado_4_tipo:'OBRAS DE SERVICIO'  ;     
   this.estado_4_por =t?.estado_4_por;     
   this.estado_4_obs =t?.estado_4_obs;     

  
   this.estado_5_tipo =t?t.estado_5_tipo:'ELEMENTOS URBANOS QUE OBSTRUYEN'  ;     
   this.estado_5_por =t?.estado_5_por;     
   this.estado_5_obs =t?.estado_5_obs;   

   this.estado_6_tipo =t?t.estado_6_tipo:'ACUMULACION DE RESIDUOS SOLIDOS'  ;     
   this.estado_6_por =t?.estado_6_por;     
   this.estado_6_obs =t?.estado_6_obs;     

   this.estado_7_tipo =t?t.estado_7_tipo:'CRUCES PEATONALES ';

   this.estado_7_por =t?.estado_7_por;     

   this.estado_7_obs =t?.estado_7_obs; 

   this.estado_8_tipo =t?t.estado_8_tipo:'CRUCES VEHICULARES NO SEÑALIZADOS';     

   this.estado_8_por =t?.estado_8_por;     
   this.estado_8_obs =t?.estado_8_obs;   
   
   
   this.seguridad_1_tipo = t?t.seguridad_1_tipo:'ILUMINACION';
   this.seguridad_1_por = t?.seguridad_1_por;
   this.seguridad_2_tipo = t?t.seguridad_2_tipo:'EQUIPAMIENTO DE SEGURIDAD';
